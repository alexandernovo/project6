            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="fw-semibold mb-0 text-nowrap">Records Report | Incident</h4>
                    </div>
                    <nav aria-label="breadcrumb" class="breadcrum-sm-class">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Records Report | Incident</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <table class="table-bordered border-dark table mt-3">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center p-1 align-middle" style="font-size: 12px" style="font-size: 12px">Type of Incident</th>
                            <th class="text-center p-1 align-middle" style="font-size: 12px" style="font-size: 12px">Date & Time of Occurence</th>
                            <th class="text-center p-1 align-middle" style="font-size: 12px" style="font-size: 12px">Barangay</th>
                            <th class="text-center p-1 align-middle" style="font-size: 12px" style="font-size: 12px">Specific Location</th>
                            <th class="text-center p-1 align-middle" style="font-size: 12px" style="font-size: 12px">Detailed Description<br>of
                                Incident</th>
                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td class="text-center px-2 py-1 align-middle" style="font-size: 12px">{{ $d->fullname }}</td>
                                <td class="text-center px-2 py-1 align-middle" style="font-size: 12px">
                                    {{ date('F d, Y h:i a', strtotime($d->datetimeoccurence)) }}
                                </td>
                                <td class="text-center px-2 py-1 align-middle" style="font-size: 12px">{{ $d->barangay }}</td>
                                <td class="text-center px-2 py-1 align-middle" style="font-size: 12px">{{ $d->specificlocation }}</td>
                                <td class="text-center px-2 py-1 align-middle" style="font-size: 12px">{{ $d->detaileddesc }}</td>
                                <td class="text-center p-0 align-middle" style="font-size: 12px">
                                    <div class="d-flex h-100">
                                        <div style="border-right: 1px solid black;" class="w-50 h-100 p-1">
                                            {{ $d->involvedinjured }}</div>
                                        <div class="w-50 h-100 p-1">{{ $d->involveddead }}</div>
                                    </div>
                                </td>
                                <td class="text-center px-2 py-1 align-middle" style="font-size: 12px">
