    ...
    <div class="row mx-auto">
                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrum-sm-class">
                        <ol class="breadcrumb mb-1">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Situational Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        @if (auth()->user() && auth()->user()->usertype == 'STAFF')
            <div class="d-flex justify-content-end mb-2 px-0">
                <button class="btn btn-red fw-semibold openNewReport" data-type="situational" data-table="situational">
        ...
        <div class="card w-100 px-0 mb-0">
            <div class="card-body p-3">
                <table id="situationalreportTable" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Staff</th>
                            ...
                            <th>Person/Individuals</th>
                            <th>Evacuation Center/Outside</th>
                            <th>Remarks</th>
...
@section('js')
    @include('situationalreport.js.situationalreport')
