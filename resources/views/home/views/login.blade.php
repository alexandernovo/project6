...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-center align-items-center gap-5 bg-home"
        ...
        <div class="card col-4" style="border-radius: 14px; background-color: #545454">
            <div class="card-body">
                ...
                <div>
                    ...
                    <form id="login_form_staff">
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-prime w-100" style="background-color: #630F0F !important">Log in</button>
