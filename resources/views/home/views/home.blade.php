...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-center align-items-center gap-5 bg-home"
        ...
        <div class="text-start text-white">
            <p class="mb-3" style="font-size: 30px">Welcome to</p>
            <p class="mb-1" style="font-size: 56px; font-weight: bold">TIBIAO MDRRMO Portal</p>
            <p class="mb-2 mt-3" style="font-size: 30px;">
