<div class="modal fade" id="newstoreModal" data-bs-backdrop="static" tabindex="-1"
    aria-labelledby="newstoreModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row mx-auto">
                        <div class="col-6">
                            ...
                            <div class="form-group mb-1">
                                <label for="" class="mb-1">Owner of Store</label>
