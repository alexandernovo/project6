<script>
    ...
    function appendButtonsincidentreport() {
        $('#incidentreportTable_wrapper .row .dt-length').append(`
            <div class="d-flex gap-2 ms-2 align-items-center incidentreportBtnSm">
                ...
                <button class="btn btn-gray-new d-flex flex-nowrap align-items-center gap-2" id="reloadincidentreportBtn">
                    <span>
    ...
    $(document).on("click", ".remarksBtn", function() {
        ...
        $("#remarksAdminTitle").text("TIBIAO MDRRMO INCIDENT REPORT REMARKS");
        if (isStaff) {
