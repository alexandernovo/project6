...
class InventoryReportController extends Controller
{
    ...
    public function save_new_inventoryreport(Request $request)
    {
        try {
            DB::beginTransaction();
            ...
            if ($record_id == 0) {
                $all['status'] = "ACTIVE";
                $all['typeOfRecord'] = "INVENTORYREPORT";
            ...
            return response()->json([
                'status' => 'success',
                'message' => "inventoryreport saved successfully"
            ]);
        } catch (Exception $ex) {
            DB::rollBack();
...
")
            ...
            ->where("records.typeOfRecord", "INVENTORYREPORT");
    ...
    public function deleteinventoryreport(Request $request)
    {
        ...
        return response()->json([
            'status' => 'success',
            'message' => "inventoryreport deleted successfully"
        ]);
    }
}
