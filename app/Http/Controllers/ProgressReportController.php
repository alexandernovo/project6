...
class ProgressReportController extends Controller
{
    ...
    public function save_new_progressreport(Request $request)
    {
        try {
            DB::beginTransaction();
            ...
            if ($record_id == 0) {
                $all['status'] = "ACTIVE";
                $all['typeOfRecord'] = "PROGRESSREPORT";
            ...
            return response()->json([
                'status' => 'success',
                'message' => "progressreport saved successfully"
            ]);
        } catch (Exception $ex) {
            DB::rollBack();
    ...
    public function getprogressreports(Request $request)
    {
...
")
            ...
            ->where("records.typeOfRecord", "PROGRESSREPORT");
    ...
    public function deleteprogressreport(Request $request)
    {
        ...
        return response()->json([
            'status' => 'success',
            'message' => "progressreport deleted successfully"
        ]);
    }
}
